...
tf.app.flags.DEFINE_string(
    'pretrained_model', './data/pretrained_models/model.ckpt-1000',
...
tf.app.flags.DEFINE_string(
    'dataset_name2','resnet',
    'The_name of the dataset to load.')

tf.app.flags.DEFINE_string(
    'dataset_split_name', 'train2014',
    'The name of the train/test/val split.')
#add dataset_split_dir
tf.app.flags.DEFINE_string(
    'dataset_split_name2', 'train',
