...
##change
from libs.datasets import download_and_convert_resnet
...
def main(_):
  ...
  elif FLAGS.dataset_name == 'resnet':
    download_and_convert_resnet.run(FLAGS.dataset_dir2, FLAGS.dataset_split_name2)
  else:
    raise ValueError(
